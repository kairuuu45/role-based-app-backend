...
const app = express();
const PORT = 3000;
const SECRET_KEY = 'your-very-secure-secret'; // Use env variables in production!
...
// consule.log(bcrypt.hashSync('admin123', 10)); // Use this to generate real hashes
...
app.post('/api/register', async (req, res) => {
  ...
  const newUser = {
    ...
    role, // ⚠️ In real apps, role should NOT be set by client!
  };
...
// PRODECTION ROUTE: Get user profile
